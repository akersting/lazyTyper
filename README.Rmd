...
|          Type |     length    |   min_length  |   max_length  |      set      |      min      |      max      |     whole     |    pattern    |    allow_NA   |   allow_NaN   | allow_NULL |       type      |
|--------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:----------:|:---------------:|
|   **.vector** | _not checked_ | _not checked_ | _not checked_ | _not checked_ | _not checked_ | _not checked_ | _not checked_ | _not checked_ | _not checked_ | _not checked_ | _no/FALSE_ |      _N/A_      |
|    **vector** |               |               |               |    &mdash;    |    &mdash;    |    &mdash;    |    &mdash;    |    &mdash;    |    &mdash;    |    &mdash;    |            |   ~~"vector"~~  |
|   **logical** |               |               |               |    &mdash;    |    &mdash;    |    &mdash;    |    &mdash;    |    &mdash;    |               |    &mdash;    |            |  ~~"logical"~~  |
|   **numeric** |               |               |               |               |               |               |               |    &mdash;    |               |               |            |  ~~"numeric"~~  |
|   **integer** |               |               |               |    &mdash;    |               |               |    ~~TRUE~~   |    &mdash;    |               |               |            |  ~~"numeric"~~  |
|     **count** |               |               |               |    &mdash;    |     ~~0~~     |               |    ~~TRUE~~   |    &mdash;    |               |               |            |  ~~"numeric"~~  |
|    **scalar** |     ~~1~~     |    &mdash;    |    &mdash;    |               |               |               |               |    &mdash;    |     FALSE     |     FALSE     |            |  ~~"numeric"~~  |
| **character** |               |               |               |               |    &mdash;    |    &mdash;    |    &mdash;    |               |               |    &mdash;    |            | ~~"character"~~ |
|    **string** |     ~~1~~     |    &mdash;    |    &mdash;    |               |    &mdash;    |    &mdash;    |    &mdash;    |               |     FALSE     |    &mdash;    |            | ~~"character"~~ |
