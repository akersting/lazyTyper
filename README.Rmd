...
|          Type |     length    |   min_length  |   max_length  |      set      |      min      |      max      |     whole     |    pattern    | allow_duplicates |    allow_NA   |   allow_NaN   | allow_NULL |       type      |
|--------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:----------------:|:-------------:|:-------------:|:----------:|:---------------:|
|   **.vector** | _not checked_ | _not checked_ | _not checked_ | _not checked_ | _not checked_ | _not checked_ | _not checked_ | _not checked_ |   _not checked_  | _not checked_ | _not checked_ | _no/FALSE_ |      _N/A_      |
